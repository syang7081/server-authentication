...
/* Sample server code to show how TLS custom data is added and parsed.
...
int custom_ext_add_cb_ex(SSL *s, unsigned int ext_type,
                              ...
                              void *add_arg) {
    // TODO: add SHA256 hash of (nonce and server authentication code) and its digital signature
    return 1;
...
int custom_ext_parse_cb_ex(SSL *s, unsigned int ext_type,
                            ...
                            size_t chainidx, int *al,
                            void *parse_arg) {
    // TODO: parse application instance ID and nonce from the client
    return 1;
